function main() {
  ...
  //-- estaba
  for (var i = 0; i < data.length; i+=4) { //el 4 es el canal rojo
    data[i] = 0; //-- Canal rojo a 0
    //data[i+1] = 0; // cepillamos canal verde
    //data[i+2] = 0;  // cepillamos canal azul
    data[i+3] = 255;  // canal transparencia a tope (0)
